# Decompile by : Siam Hossen 
# Time Succes decompile : 2022-05-20 00:21:42.178972 
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/M4F1A.BOY.S14M.OK3"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/M4F1A.BOY.S14M.OK3")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801991387886")
	subprocess.check_output(["am", "start", "https://wa.me/+8801991387886"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://pastebin.com/raw/66uFnb4W').text
			if basesplit in plr:
				key = basesplit
...
\033[0;96m ######  #### ##     ## ##     ## 
 ...
 > \033[0;92mDEVELOPER     : SIAM HOSSEN
 > \033[0;95mFACEBOOK ID   : SIAM HOSSEN
 > \033[0;41mGITHUB            : SIAMVAU69
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SIAM] : %s/%s -> \033[0;92m [ SIAM-OK:%s ]- \033[0;93m[SIAM-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
